...
const SKILLS = {
  "Core Backend":        { color: "#4f8ef7", items: ["Python", "Django", "DRF", "FastAPI", "Flask", "Celery", "Redis", "JWT", "OAuth2"] },
  "AI / ML":             { color: "#a78bfa", items: ["LangChain", "LangGraph", "Agentic RAG", "FAISS", "ChromaDB", "SentenceTransformers", "Groq API"] },
